            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              <div className="md:w-1/2 space-y-8">
                ...
                <p className="text-xl text-gray-600">
                  Experience hassle-free vehicle insurance with our modern
                  digital platform. Get instant quotes, manage your policies
                  online, and process claims quickly with our user-friendly
                  system.
                </p>
                <div className="flex items-center space-x-4">
                  <button className="px-8 py-4 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition duration-300 font-semibold shadow-lg hover:shadow-indigo-500/30">
                    Get Started
                  </button>
